...
class MidiOut
{
  ...
  __new(devID=-1)
	...
	controlChange(controller, value, channel="")
	{
		...
		;MsgBox, seinding conc %channel%
		return this.channel[channel]._controlChange(controller, value)
    ...
    class MidiOutChannel
    {
		...
		{
			;MsgBox, seinding cc %value%
			return this._midiOut._message(((value&0xff)<<16)|((controller&0xff)<<8)|((this._channelID)|0xf)|0xB0)
		}
    }
}